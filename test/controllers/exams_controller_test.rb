...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { alamat: @exam.alamat, nama: @exam.nama, profesi: @exam.profesi } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { alamat: @exam.alamat, nama: @exam.nama, profesi: @exam.profesi } }
